            ...
            if (resultadosObtenido.Count() > 0)
            {
                ...
                foreach (Peticion_obr obrPeticion in peticionActual.ListaORB)
                {
                    ...
                    if (ResultadosObx.Count() > 0)
                    {
                        ...
                        nuevaObrResult.Obr_24_DiagnosticServiceID = managerDBOpenf.getTipoExame(ResultadosObx[0].Estudio);//REVISAR ESTO  *Revisado
                        ...
                        if (!orcCargado)
                        {
                            ...
                            string orc = @"ORC|" + resultadoRepuesta.Orc_1_codigoDeControl + "|" +peticionActual.Orc2_placerOrderNumer + "|||" + resultadoRepuesta.Orc_5_EstatusOrden + "||||" + resultadoRepuesta.Orc_9_FechaDeEnvio + "|||" + resultadoRepuesta.Orc_12_1_CodigoProfesional.TrimStart('q', 'Q', 'h', 'H', 'u', 'U', 'c', 'C') + "^" + resultadoRepuesta.Orc_12_2_NombreProfesional + "_z";
                        ...
                        if (TipoExamenPlantilla == "A")
                        {
                            foreach (resultview resultadoAImprimir in ResultadosObx)
                            {
                                ...
                                if (isNumeric)
                                {
                                    ...
                                    nuevaObxCualitativo.Obx_4_IdDelResultado = "3";//revisar
                                    nuevaObxCualitativo.Obx_5_ResultadoCualitativo = "ANORMAL"; //revisar
                        ...
                        string obr = @"OBR|" + nuevaObrResult.Obr_1_IDOBR + "|" + nuevaObrResult.Obr_2_PlacerOrdeNumber + "||" + nuevaObrResult.Obr_4_1_Identifier + "^" + nuevaObrResult.Obr_4_2_Text + "^L^" + nuevaObrResult.Obr_4_4_AlternateIdentifier + "^" + nuevaObrResult.Obr_4_5_AlternateText + "||||" + nuevaObrResult.Obr_8_ObservationEndDateTime + "||" + nuevaObrResult.Obr_10_CollectorIdentifier + "||||||" + resultadoRepuesta.Orc_12_1_CodigoProfesional.TrimStart('q','Q','h','H','u','U','c','C','p','P') + "^" + resultadoRepuesta.Orc_12_2_NombreProfesional + "||||||" + nuevaObrResult.Obr_22_ResultReptStatusChangeDateTime + "||" + nuevaObrResult.Obr_24_DiagnosticServiceID + "|" + nuevaObrResult.Obr_25_ResultStatus + "_z";
                        respuesta += obr;
